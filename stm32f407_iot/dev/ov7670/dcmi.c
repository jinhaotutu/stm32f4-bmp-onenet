...
void My_DCMI_Init(void)
{
	...
	RCC_AHB2PeriphClockCmd(RCC_AHB2Periph_DCMI,ENABLE);//使能DCMI时钟
  	...
  	GPIO_InitStructure.GPIO_Pin = GPIO_Pin_6|GPIO_Pin_7|GPIO_Pin_8|GPIO_Pin_9;//PC6/7/8/9 复用功能输出 D0 D1 D2 D3
  	GPIO_Init(GPIOC, &GPIO_InitStructure);//初始化	

  	GPIO_InitStructure.GPIO_Pin = GPIO_Pin_4|GPIO_Pin_5|GPIO_Pin_6;//PE4/5/6  复用功能输出  D4 D6 D7
